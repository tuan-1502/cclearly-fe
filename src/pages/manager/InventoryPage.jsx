...
import { Search, Package, Warehouse, AlertTriangle, X, Upload, ChevronDown, ChevronRight } from 'lucide-react'
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-[#4f5562]">Quản lý tồn kho chi tiết theo biến thể - {stores[0]?.name || 'Store 1'}</p>
        </div>
        <button
      ...
      <div className="bg-white rounded-xl p-5 shadow-sm">
        <div className="flex flex-wrap gap-4 items-center justify-between">
          ...
          <div className="flex items-center gap-2 bg-gray-100 p-1 rounded-lg">
            ...
            <button
              onClick={() => { setTypeFilter('frame'); setCurrentPage(1); }}
            ...
            <button
              onClick={() => { setTypeFilter('lens'); setCurrentPage(1); }}
            ...
            <button
              onClick={() => { setTypeFilter('accessory'); setCurrentPage(1); }}
                ...
                return (
                  <React.Fragment key={product.id}>
                    ...
                    {isExpanded && hasVariants && product.variants.map((variant) => (
                      <tr key={variant.id} className="bg-blue-50/50 hover:bg-blue-50">
                        ...
                        <td className="px-4 py-3 pl-12">
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-[#222]">
                              {variant.color || variant.technology || variant.material || 'Default'}
                            </span>
                          </div>
                        </td>
                        <td className="px-4 py-3 text-sm text-[#4f5562]">{variant.sku}</td>
                        <td className="px-4 py-3">
                        ...
                        <td className="px-4 py-3">
                          <span className={`font-medium ${variant.stock < 5 ? 'text-orange-600' : 'text-[#222]'}`}>
                            {variant.stock}
                          </span>
                        </td>
                        <td className="px-4 py-3 text-sm font-medium text-[#222]">
