    ...
    warning: {
      ...
      icon: (
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 9v2m0 4h.01m20.96 0a9 9 0 01-16 0 9 9 0 0116 0zm0 0v4m-9-9a9 9 0 0118 0z" />
        </svg>
      )
    },
    danger: {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-2xl shadow-xl max-w-md w-full mx-4 p-6 animate-in fade-in zoom-in-95 duration-200">
        ...
        {/* Icon */}
        <div className={`w-12 h-12 ${styles.bg} rounded-full flex items-center justify-center mx-auto mb-4`}>
